...
object UiConstants {
    ...
    // Comment
    const val COMMENT_FIELD_MIN_LINES = 4
    ...
    // Favorites screen
    val FavoriteCardRadius = 22.dp
    val FavoriteCardBorderWidth = 1.dp
    val FavoriteCardElevation = 3.dp
    val EmptyFavoritesImageSize = 360.dp
